...
if (!defined('ROOT_PATH')) {
    define('ROOT_PATH', realpath(__DIR__ . '/../../../..')); // Adjust path as needed
}
...
// Host name (e.g. "nameless.deps.dist")
$host = $_SERVER['HTTP_HOST'];

// Current path (e.g. "/index.php?route=/panel/allinoneaccessibility")
$path = $_SERVER['REQUEST_URI'];

// Full current URL
$current_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$host$path";

// Base URL of the website (e.g. "http://nameless.deps.dist/")
...
<head>
    ...
    <title>Nameless MC</title>
    <meta name="description" content="Nameless MC" />
    <link href="modules\All in One Accessibility\pages\css\bootstrap.min.css" rel="stylesheet">
    <link href="modules\All in One Accessibility\pages\css\style.css?4=8" rel="stylesheet">
</head>
...
<body>
    ...
    <?php { ?>
        ...
        <script src="modules\All in One Accessibility\pages\js\bootstrap.bundle.min.js"></script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: 'modules/All in One Accessibility/pages/route.php?action=fetchWidgetSettings',
            type: 'POST',
            dataType: 'text', // Or 'json' if your route returns JSON
            // dataType: 'json',
            data: JSON.stringify({ user_data: userData }),
    ...
    $("#submit").click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.ajax({
                    url: 'modules/All in One Accessibility/pages/route.php?action=settingsUpdated',
                    type: 'POST',
                    data: params,
                    dataType: 'json',
                    success: function(response) {
